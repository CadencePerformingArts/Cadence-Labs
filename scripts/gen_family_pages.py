...
PAGES = {
    ...
    "uil": {
        "root": "..",
        "title": "Cadence UIL — Texas Marching Band Scores",
        "brand_tag": "UIL",
        "activity": "Texas",
        ...
        "events_title": "Shows",
        "nav": ["Scoreboard", "Shows", "Bands", "Stats"],
        "class_order": ["6A", "5A", "4A", "3A", "2A", "1A"],
        "credit": "Not affiliated with the University Interscholastic League.",
    },
    "state/indiana": {
        "root": "../..",
        "title": "Cadence ISSMA — Indiana Marching Band Scores",
        "brand_tag": "ISSMA",
        "activity": "Indiana",
        "app_name": "Cadence ISSMA Indiana",
        "short_name": "ISSMA",
        "accent": "#0d9488",
        "ns": "issma:",
        "extra_tab": ("State", "#/champions"),
        ...
        "events_title": "Shows",
        "nav": ["Scoreboard", "Shows", "Bands", "Stats"],
        "class_order": ["Open A", "Open B", "Open C", "Open D"],
        "credit": "Not affiliated with ISSMA.",
    },
    "state/ohio": {
        "root": "../..",
        "title": "Cadence OMEA — Ohio Marching Band Scores",
        "brand_tag": "OMEA",
        "activity": "Ohio",
        "app_name": "Cadence OMEA Ohio",
        "short_name": "OMEA",
        "accent": "#0d9488",
        "ns": "omea:",
        "extra_tab": ("State", "#/champions"),
        ...
        "events_title": "Shows",
        "nav": ["Scoreboard", "Shows", "Bands", "Stats"],
        "class_order": ["Class AA", "Class A", "Class B", "Class C"],
        "credit": "Not affiliated with OMEA.",
    },
    "state/florida": {
        "root": "../..",
        "title": "Cadence FMBC — Florida Marching Band Scores",
        "brand_tag": "FMBC",
        "activity": "Florida",
        "app_name": "Cadence FMBC Florida",
        "short_name": "FMBC",
        "accent": "#0d9488",
        "ns": "fmbc:",
        "extra_tab": ("State", "#/champions"),
        ...
        "credit": "Not affiliated with FMBC.",
    },
    "usbands": {
        "root": "..",
    ...
    "showchoir": {
        ...
        "events_title": "Shows",
        "nav": ["Scoreboard", "Shows", "Choirs", "Stats"],
