...
PAGES = {
    ...
    "acappella": {
        ...
        "accent": "#0891b2",
        "ns": "aca:",
        "score_note": "Varsity Vocals is a bracket: points rank groups within one round. This board shows each group's most recent judged score on their road to Finals.",
        "terms": {"singular": "group", "plural": "groups", "a": "a group"},
        "events_title": "Shows",
        "nav": ["Scoreboard", "Shows", "Groups", "Stats"],
