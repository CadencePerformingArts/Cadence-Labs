...
## Alternative pitch (FloSports partnerships, 2 lines)

Cadence is a free fan scoreboard for the marching arts reaching DCI and WGI
fans daily; we'd like to surface FloMarching links beside every event's scores.
Could we discuss a partnership — official results access in exchange for
prominent stream-referral placement across the app?
